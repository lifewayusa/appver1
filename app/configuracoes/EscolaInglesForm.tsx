...
export default function EscolaInglesForm() {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    setMsg("");
    const res = await fetch("/api/admin/escolas-ingles", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(form),
    });
    if (res.ok) setMsg("Escola de inglês cadastrada!");
    else setMsg("Erro ao cadastrar escola de inglês");
  };
